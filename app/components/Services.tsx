      ...
      <div className="max-w-[1600px] mx-auto px-6 lg:px-12">
        <div className="grid grid-cols-12 gap-8 mb-20">
          ...
          <div className="col-span-12 lg:col-span-10">
            ...
            <p className="mt-8 text-rangers-bone/70 max-w-2xl text-lg leading-relaxed">
              팀의 시즌 진단부터, 다음 경기 예측, 선수의 동작 분석, 그리고 누구나
              볼 수 있는 인사이트 대시보드까지. 야구를 둘러싼 질문에 데이터로 답합니다.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-white/5 border border-white/5">
          {services.map((s) => (
            ...
            >
              ...
              {/* Description */}
              <p className="mt-6 text-rangers-bone/75 leading-relaxed text-[15px]">
                {s.desc}
              </p>
            </div>
          ))}
